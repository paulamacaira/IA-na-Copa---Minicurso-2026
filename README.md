...
*   `/notebooks`: Jupyter Notebooks com os tutoriais passo a passo.
*   `/scripts`: Scripts utilitários e funções auxiliares.
*   `/slides`: Apresentações e materiais teóricos.

## 🛠 Pré-requisitos
Para rodar os exemplos deste repositório, recomenda-se ter instalado:
*   Python 3.x
*   Jupyter Notebook ou VS Code
*   Bibliotecas principais: `pandas`, `numpy`, `scikit-learn`, `matplotlib`, `seaborn` (instale via `pip install -r requirements.txt`).

## 🎓 Como utilizar
1. Clone este repositório:
   ```bash
   git clone [https://github.com/paulamacaira/IA-na-Copa---Minicurso-2026.git](https://github.com/paulamacaira/IA-na-Copa---Minicurso-2026.git)
